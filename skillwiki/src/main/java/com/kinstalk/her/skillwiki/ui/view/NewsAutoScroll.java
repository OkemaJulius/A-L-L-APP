package com.kinstalk.her.skillwiki.ui.view;
...
public class NewsAutoScroll extends ScrollView {

    private static final String TAG = "NewsAutoScroll";

    private boolean isScrolledToTop = true;// 初始化的时候设置一下值
    private boolean isScrolledToBottom = false;

    public NewsAutoScroll(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
