package com.kinstalk.m4.publicutils.data;
 ...
 * 比如：timer_duration
 */
public class M4SharedPreferences {
    private static final String PREFERENCES_FILENAME = "m4_sp";

    private static M4SharedPreferences sInstance;

    private Context mAppContext;

    private SharedPreferences sp;

    private M4SharedPreferences(Context context) {
        mAppContext = context.getApplicationContext();
    }

    public static M4SharedPreferences getInstance(Context context) {
        synchronized (M4SharedPreferences.class) {
            if (sInstance == null) {
                sInstance = new M4SharedPreferences(context);
            }
        }
        return sInstance;
    }
