 ...
 */
package com.kinstalk.m4.skilltimer.ui;
...
public class ProgressLayout extends View implements Animatable {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paintProgressLoaded.setDither(true);


        if (progressLoadedColors != null) {
            if (mGradientShader == null) {
                mGradientShader = new LinearGradient(0, 0, mWidth, 0, progressLoadedColors
                        , null, Shader.TileMode.CLAMP);
            }
            paintProgressLoaded.setShader(mGradientShader);
        }
    ...
    public void setBorderGradientColors(int[] colors) {
        this.progressLoadedColors = colors;
    }
