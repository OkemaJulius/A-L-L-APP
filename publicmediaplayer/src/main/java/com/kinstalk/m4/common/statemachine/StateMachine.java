...
package com.kinstalk.m4.common.statemachine;
...
public class StateMachine {
    ...
    protected final void removeDeferredMessages(int what) {
        ...
        synchronized (smh.mDeferredMessages) {
    ...
    public static class LogRec {
        ...
        public String toString() {
            ...
            sb.append(String.format(Locale.US, "%tm-%td %tH:%tM:%tS.%tL", c, c, c, c, c, c));
            sb.append(" processed=");
    ...
    private static class SmHandler extends Handler {
        ...
        private final void cleanupAfterQuitting() {
            ...
            mInitialState = null;
            mDestState = null;
            synchronized (mDeferredMessages) {
